...
# read lines
lines_blogs<- obtainLines(fn_blogs)
lines_twitter<- obtainLines(fn_twitter)
lines_news<- obtainLines(fn_news)

# tokenize from lines
tkn_blogs<- tokenizeFromLines(lines_blogs)
tkn_twitter<- tokenizeFromLines(lines_twitter)
tkn_news<- tokenizeFromLines(lines_news)
